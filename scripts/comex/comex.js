...
(function ($) {
    ...
    String.prototype.normalize.map = [
        ...
        ["GO", "JO"], ["GU", "JU"], ["YA", "JA"], ["YE", "JE"], ["YO", "JO"], ["V", "B"], ["XO", "SO"], ["XI", "JI"], ["Y", "I"]
    ];
    ...
    String.prototype.toTitleCase = String.toTitleCase || function(){
		//http://stackoverflow.com/questions/196972/convert-string-to-title-case-with-javascript
		return this.replace(/\w\S*/g, function(txt){return txt[0].toUpperCase() + txt.substr(1).toLowerCase();});
	};
...
IDatabase.data = function (data, caller) {
    ...
    if (data.objecttype === 'table') {
        ...
        relations = rowsTable.relations.map(function (relation) {
            if (relation.table._rows && (relation.table.insert || relation.table.update)) {
...
ICell.prototype = {
    val: function (data, format) {
		...
		if($cell._val === null){ if($cell.required){$cell.validity.valid = false; $cell.validity.valueMissing = true;  return $cell; } }
		else{
