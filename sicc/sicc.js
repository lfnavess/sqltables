    ...
    $(function () {
        ...
        database.tables({
            ...
            cols: [
                ...
                { title: 'Solicitante', type: "Int", required: true, explicacion: "Es la persona cuyo CC sale pago al proveedor, si es interno o no hay costo es la persona que necesita se de la capacitación" },
                {
        ...
        database.tables({
            ...
            colsdef: [
				...
				'Alumno >CC', 'Alumno >Tipo colaborador', 'Alumno >Nivel', 'Alumno >Dirección', 'Alumno >Jefe', 'Alumno >Email', 
        ...
        database.tables({
            ...
            colsdef: [
                ...
                "Inscripción >Alumno >Lugar >Municipio >Entidad >País", "Inscripción >Alumno >Puesto", "Inscripción >Alumno >CC",
        ...
        database.tables({
			...
			colsdef: [
				...
				"Posición >Puesto", "Posición >Puesto >Nivel", "Posición >CC", "Posición >Dirección", 
				...
				"Posición >Email seguimiento", "Posición >Email valido", "Posición >Email modificado", "Posición >Email valido modificado", 
            ...
            cols: [
                ...
                { 
					...
					badInput: function(cell){ cell._val = titleCase(cell._val); },
        ...
        database.tables({
			...
			colsdef: [
				...
				"Puesto >Nivel", "CC", "Dirección", "Dirección >Posición BP >Colaborador", "Dirección >Posición BP >Email", "Tipo", 
				"Posición jefe", "Posición jefe >Colaborador", "Posición jefe >Email", "Posición director", "Posición director >Colaborador", "Email", 
				"Email seguimiento", "Email valido", "Email modificado", "Email valido modificado", "Teléfono", "Teléfono móvil", "Banda", "Equipo", 
            ...
            cols: [
                ...
                { 
					...
					onChange: function (cell, row) { row.cell("Teléfono").reeval(); }
				},
				...
				{ title: 'Email', type: 'Email', maxlength: 100, unique: true, indexMatch: true },
				{ title: 'Email modificado', type: 'Date', min: moment([2008]), max: moment() },
				{ title: 'Email valido', type: 'Bool' },
				{ title: 'Email valido modificado', type: 'Date', min: moment([2008]), max: moment() },
				{ title: 'Email seguimiento', type: 'Bool', default: true },
                {
					...
					badInput: function badInput(cell_tel){
						...
						var tttt = [
							...
							[//4
								[/^tel:[+]5255166914(?:(0[1-9]|[1-9]\d);ext=14\1|00;ext=(?:63|75)(?:0[1-9]|[1-9]\d))$/, "14XX, 63XX, 75XX"],
							...
							[//19
								[/^tel:[+]5242727191(0[1-9]|[1-9]\d);ext=31\1$/, "31XX, 91XX"],
								[/^(?:31|91)(?:0[1-9]|[1-9]\d)$/, "tel:+5242727191{0};ext=31{0}", 2, 2],
								[/^27191(?:0[1-9]|[1-9]\d)$/, "tel:+5242727191{0};ext=31{0}", 5, 2],
								[/^tel:[+]5242727191(?:0[1-9]|[1-9]\d)$/, "tel:+5242727191{0};ext=31{0}", 15, 2]
							]
						];
						var lugares = [
        ...
        //CCs
        database.tables({
            title: ['CCs', 'CC', 'centrosdecostos'],
            insert: true, update: true, delete: false,
            cols: [
                { title: 'CC ID', type: 'Int', pk: true, min:8000, max:639999 },
                { title: 'CC', readonly: true, str: true },
        ...
        database.relations(database.tables('CCs').cols("PK"), database.tables('Posiciones').cols('CC'), true);
        ...
        database.relations(database.tables('TFs').cols("PK"), database.tables('Posiciones').cols('Email valido'));
        ...
        database.relations(database.tables('TFs').cols("PK"), database.tables('Colaboradores').cols('CURP valido'));
        database.relations(database.tables('TFs').cols("PK"), database.tables('Colaboradores').cols('RFC valido'));
